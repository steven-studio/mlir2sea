...
module {
  func.func @conv1d(%arg0: memref<10xf32>, %arg1: memref<3xf32>, %arg2: memref<8xf32>) {
    %cst = arith.constant 0.000000e+00 : f32
    %c0 = arith.constant 0 : index
    %c1 = arith.constant 1 : index
    %c2 = arith.constant 2 : index
    affine.for %i = 0 to 8 step 4 {
      %in0 = vector.transfer_read %arg0[%i], %cst : memref<10xf32>, vector<4xf32>
      ...
      %in1 = vector.transfer_read %arg0[%idx1], %cst : memref<10xf32>, vector<4xf32>
      ...
      %in2 = vector.transfer_read %arg0[%idx2], %cst : memref<10xf32>, vector<4xf32>
      ...
      vector.transfer_write %acc2, %arg2[%i] : vector<4xf32>, memref<8xf32>
    }
    return
  }
}
