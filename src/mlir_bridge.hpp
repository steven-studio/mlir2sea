...
private:
    ...
    void handleSubf(mlir::Operation* op);
    void handleDivsi(mlir::Operation* op);
    void handleRemsi(mlir::Operation* op);
    void handleAndi(mlir::Operation* op);
    void handleOri(mlir::Operation* op);
    void handleXori(mlir::Operation* op);
    void handleShli(mlir::Operation* op);
    void handleShrsi(mlir::Operation* op);
    void handleFptosi(mlir::Operation* op);
    void handleUitofp(mlir::Operation* op);
    void handleMathSin(mlir::Operation* op);
    void handleMathCos(mlir::Operation* op);
    void handleMathTanh(mlir::Operation* op);
    void handleMathLog(mlir::Operation* op);
    void handleMathLog2(mlir::Operation* op);
    void handleMathPow(mlir::Operation* op);
